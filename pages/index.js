      ...
      <div className="hidden md:block">
        <Parallax pages={2} style={{ top: "0", left: "0" }}>
          <ParallaxLayer
            speed={0.8}
            style={{
              backgroundImage: `url(/image/hero-flip-background.jpg)`,
              backgroundSize: "120%",
              backgroundPosition: "20% 28%",
            }}
          >
            <div className="w-full h-full flex items-end">
              <div className="w-full h-10 bg-main-color"></div>
            </div>
          </ParallaxLayer>
          <ParallaxLayer
            speed={0.9}
            style={{
              backgroundImage: `url(/image/hero-flip.png)`,
              backgroundSize: "120%",
              backgroundPosition: "20% 28%",
            }}
          >
          ...
          <ParallaxLayer offset={0.5} speed={0.5}>
            <div className="w-2/4 h-full  flex items-start justify-center">
              <div className=" w-full p-5 flex flex-col">
                <span className="font-Poppins w-10/12 font-bold text-6xl text-second-color">
                  Love and Passion for Nature
                </span>
                <span className="font-Poppins uppercase font-semibold text-xl text-supper-main-color">
                  Trekking Thailand Tour
                </span>
                <span className="font-Poppins font-normal w-10/12  p-2 text-sm text-main-color">
