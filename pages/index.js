    ...
    <Parallax pages={3} style={{ top: "0", left: "0" }}>
        ...
        <div>
          ...
          <div className="w-full flex-col items-center h-full  flex justify-start mt-10">
            <div className="w-10/12 flex flex-col">
              ...
              <section className="w-full h-60 gap-5 mt-5 grid grid-cols-3 grid-rows-2">
      ...
      <ParallaxLayer offset={1.3} speed={0.5}>
        <div className="w-full h-full flex justify-center items-center gap-2 flex-col">
          ...
          <p className="w-10/12 flex  text-white">- Trekking Thailand Tour.</p>
      ...
      <ParallaxLayer
        style={{ backgroundColor: "#F2E3DB", position: "relative" }}
        offset={2}
      >
          ...
          >
            <SwiperSlide>
              <div className="w-full flex justify-center">
                <div className=" bg-white w-11/12 mb-8  rounded-lg p-5 flex gap-3">
                  ...
                  <section className="w-8/12 text-sm text-second-color">
                    <p>
                      <span>“</span>
                    ...
                    <p className="text-lg text-supper-main-color mt-2">Tyler</p>
                    <p className="text-xs text-main-color ">client</p>
                    <p className="text-xs font-light text-main-color ">
                      November 17th, 2022
                    </p>
                  </section>
                </div>
